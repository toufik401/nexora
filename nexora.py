...
with st.container():
    ...
    # تم تصحيح الروابط والتنسيق هنا
    st.markdown("""
        <a href="https://ibb.co/TMc4W7GS"><img src="https://i.ibb.co/v413XTWG/1782140096443.png" alt="1782140096443" border="0"></a><br />
        <a target='_blank' href='https://usefulwebtool.com/fr/convertir-texte-en-binaire'>ما معنى كلمة ثنائي (binaire)؟</a><br />
    """, unsafe_allow_html=True)
    ...
    with st.form("invoice_form", clear_on_submit=True):
        ...
        if submit:
            if name and phone:
                ...
                response = requests.post(f"https://api.telegram.org/bot{token}/sendMessage", data={"chat_id": chat_id, "text": msg})
